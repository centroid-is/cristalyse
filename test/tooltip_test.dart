...
void main() {
  group('Tooltip System', () {
    ...
    group('Default Tooltip Builders', () {
      testWidgets('should use simple tooltip builder', (
        WidgetTester tester,
      ) async {
      ...
      testWidgets('should use multi-column tooltip builder', (
        WidgetTester tester,
      ) async {
        final chart = MaterialApp(
          home: Scaffold(
      ...
      testWidgets('should use rich tooltip builder', (
        WidgetTester tester,
      ) async {
        final chart = MaterialApp(
          home: Scaffold(
    ...
    group('Custom Tooltip Configurations', () {
      testWidgets('should support custom tooltip styling', (
        WidgetTester tester,
      ) async {
        final chart = MaterialApp(
          home: Scaffold(
      ...
      testWidgets('should support custom timing configuration', (
        WidgetTester tester,
      ) async {
        final chart = MaterialApp(
          home: Scaffold(
      ...
      testWidgets('should support custom shadow and styling', (
        WidgetTester tester,
      ) async {
        final chart = MaterialApp(
          home: Scaffold(
    ...
    group('DataPointInfo Utility Methods', () {
      testWidgets('should format display values correctly', (
        WidgetTester tester,
      ) async {
    ...
    group('Business Use Cases', () {
      testWidgets('should support sales dashboard tooltips', (
        WidgetTester tester,
      ) async {
        final salesData = [
          {
      ...
      testWidgets('should support analytics dashboard tooltips', (
        WidgetTester tester,
      ) async {
        final analyticsData = [
          {
    ...
    group('Tooltip Edge Cases', () {
      testWidgets('should handle missing tooltip builder gracefully', (
        WidgetTester tester,
      ) async {
        final chart = MaterialApp(
          home: Scaffold(
      ...
      testWidgets('should handle extremely long tooltip content', (
        WidgetTester tester,
      ) async {
        final chart = MaterialApp(
          home: Scaffold(
      ...
      testWidgets('should handle tooltip with complex widgets', (
        WidgetTester tester,
      ) async {
        final chart = MaterialApp(
          home: Scaffold(
